...
async def debug_token(request: Request):
    """Route de debug — vérifie le token reçu sans bloquer"""
    ...
    try:
        ...
        return {"statut": "OK ✅", "user_id": payload.get("sub"), "secret_longueur": secret_len}
    except Exception as e:
        return {"statut": "ERREUR ❌", "detail": str(e), "secret_longueur": secret_len, "token_debut": token[:40]}
